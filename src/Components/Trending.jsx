...
const Trending = () => {
  ...
  return trending.length > 0 ? (
    <div
    id="trending-scrollable"
     className="w-screen h-screen py-[1%] overflow-x-hidden overflow-y-auto ">
      <div className="w-full flex items-center px-[3%]">
      <h1 className="text-2xl font-semibold text-zinc-400 flex items-end gap-2">
          <i
            onClick={() => navigate(-1)}
            className="ri-arrow-left-line hover:text-[#6556cd] mr-3 cursor-pointer"
          ></i>
      ...
      <InfiniteScroll
        ...
        loader={<h1>Loading...</h1>}
         scrollableTarget="trending-scrollable"
      >
