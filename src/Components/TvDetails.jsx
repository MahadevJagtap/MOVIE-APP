...
import { asyncloudtv, removetv } from "../store/actions/tvActions";
...
const TvDetails = () => {
  ...
  return info ? (
    ...
    >
      ...
      <h1 className="text-3xl font-bold text-white my-5">Seasons</h1>
      <div className="flex h-[50vh] overflow-x-auto px-5 py-2 mb-5">
        {info.detail.seasons.map((s, i) => {
          return (
            <div
              key={i}
              className="min-w-[15%] rounded-lg mr-5 overflow-hidden"
            >
              <img
